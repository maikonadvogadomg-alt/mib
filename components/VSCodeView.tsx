...
type Mode = "codeserver" | "vscodedev" | "githubdev" | "stackblitz" | "gitpod" | "guide";
      ...
      <View style={styles.container}>
        ...
        <View style={[styles.topBar, { paddingTop: insets.top + 4 }]}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ flex: 1 }} contentContainerStyle={{ gap: 4, paddingHorizontal: 8, alignItems: "center" }}>
            {(["codeserver", "vscodedev", "githubdev", "stackblitz", "gitpod", "guide"] as Mode[]).map((m) => {
              const isActive = mode === m;
              const colors: Record<Mode, string> = {
                codeserver: "#007acc", vscodedev: "#007acc", githubdev: "#e0e0e0",
                stackblitz: "#1389fd", gitpod: "#ff8a00", guide: "#4ade80",
              };
              const tc = isActive ? colors[m] : "#888";
              return (
                <TouchableOpacity
                  key={m}
                ...
                >
                  ...
                  <Text style={[styles.modeTabText, isActive && { color: colors[m] }]}>
                    {MODE_LABELS[m]}
                  </Text>
                </TouchableOpacity>
              );
        ...
        {mode === "guide" ? (
          <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
            ...
            <View style={[styles.guideSection, { backgroundColor: "#0d1a2d", borderColor: "#1e3a5f" }]}>
              ...
              <Text style={styles.guideText}>Todas as abas abaixo funcionam SEM o servidor Replit — precisam apenas de internet:</Text>
              {[
